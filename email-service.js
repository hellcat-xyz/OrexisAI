        ...
        async sendPasswordReset({ to, resetUrl, expiresMinutes }) {
            if (!isConfigured) {
                throw createEmailError(
                    ...
                    'Password reset email is not configured. Set EMAIL_PROVIDER, RESEND_API_KEY, and EMAIL_FROM.',
                    503
                );
            }
            ...
            try {
                ...
                if (error?.name === 'AbortError') {
                    throw createEmailError('EMAIL_TIMEOUT', 'Password reset email request timed out.', 504);
                }
